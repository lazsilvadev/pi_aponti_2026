...
def criar_calculadora_view(page: ft.Page):
    ...
    try:
        mode_switch.on_change = _on_mode_switch_change
    except Exception:
        try:
            mode_switch.on_click = _on_mode_switch_change
        except Exception:
            pass
    ...
    txt_taxa_debito.on_change = lambda e: None
    txt_taxa_credito.on_change = lambda e: None
    mode_switch.on_change = calcular
