...
def create_configuracoes_view(
                                    ...
                                    ft.Row(
                                        [
                                            ft.ElevatedButton(
                                                ...
                                                width=28,
                                                height=28,
                                                on_click=lambda e, r=icon_color_ref: set_color_field(
                                                    r, "#034986"
                                                ),
                                            ),
                                            ft.ElevatedButton(
                                    ...
                                    ft.Row(
                                        [
                                            ft.ElevatedButton(
                                                ...
                                                width=28,
                                                height=28,
                                                on_click=lambda e, r=login_btn_bg_ref: set_color_field(
                                                    r, "#034986"
                                                ),
                                            ),
                                            ft.ElevatedButton(
                                    ...
                                    ft.Row(
                                        [
                                            ft.ElevatedButton(
                                                ...
                                                width=28,
                                                height=28,
                                                on_click=lambda e, r=login_btn_text_ref: set_color_field(
                                                    r, "#034986"
                                                ),
                                            ),
                                            ft.ElevatedButton(
    ...
    def open_pix_settings(e=None):
        ...
        try:
            # importar dinamicamente e gerar conteúdo
            ...
            try:
                content = mod.create_pix_settings_modal_content(page, close_overlay)
            except Exception:
                try:
